  ...
  return (
    <div className="container w-full min-h-screen p-4 mx-auto bg-red-200">
      <div className="flex">
        ...
        <div
          className="flex items-center justify-center w-[32px] h-[32px] rounded-full border border-emerald-400"
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="flex items-center justify-center">
          {/*estado inicial inactivo*/}
          <div className="items-center justify-center w-[180px] h-[3px] bg-gray-200 -ml-0.5 -mr-0.5 z-0"></div>
          <div className="flex items-center justify-center w-[32px] h-[32px] bg-gray-200 rounded-full z-10">
            2
          </div>
        </div>
